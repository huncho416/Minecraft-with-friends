...
- 🚧 Punishment full YAML-backed menu text, blacklist enforcement at login/grant time (the hydration sink tracks blacklist state — a login listener still needs to consult it), and complete command parsing for quoted multi-word template titles remain pending.
