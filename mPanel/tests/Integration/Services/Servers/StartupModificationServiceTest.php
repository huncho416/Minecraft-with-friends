...
class StartupModificationServiceTest extends IntegrationTestCase
{
     ...
     * a non-admin entity.
     */
    public function test_non_admin_can_modify_server_variables()
    {
     ...
     */
    public function test_server_is_properly_modified_as_admin_user()
    {
        $server = $this->createServerModel();
     ...
     */
    public function test_environment_variables_can_be_updated_by_admin()
    {
        $server = $this->createServerModel();
     ...
     */
    public function test_invalid_egg_id_triggers_exception()
    {
        $server = $this->createServerModel();
