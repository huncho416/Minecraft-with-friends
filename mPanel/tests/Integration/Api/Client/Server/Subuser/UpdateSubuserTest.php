...
class UpdateSubuserTest extends ClientApiIntegrationTestCase
{
     ...
     */
    public function test_correct_permissions_are_required_for_updating()
    {
     ...
     */
    public function test_permissions_are_saved_to_account()
    {
     ...
     * themselves.
     */
    public function test_user_cannot_assign_permissions_they_do_not_have()
    {
     ...
     */
    public function test_user_cannot_update_self()
    {
        [$user, $server] = $this->generateTestAccount([Permission::ACTION_USER_READ, Permission::ACTION_USER_UPDATE]);
     ...
     */
    public function test_cannot_update_subuser_for_different_server()
    {
        [$user, $server] = $this->generateTestAccount();
