...
return [
    ...
    'feedback-body' => 'Si has disfrutado de las funciones y la facilidad de uso que ofrece Mythic Panel, ¡cuéntanoslo! Tus comentarios nos ayudan a mejorar y a crear herramientas aún más increíbles para ti.',
    'feedback-btn' => 'Crear incidencia',
    'sponsor-header' => 'Apoya a Mythic Panel',
    'sponsor-body' => 'Gracias por utilizar Mythic Panel, ¡esto solo ha sido posible gracias a vuestro apoyo, el de nuestros colaboradores, y del resto de nuestros seguidores! Agradecemos cualquier tipo de apoyo.',
