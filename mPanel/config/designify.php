...
return [
    'site_title' => 'Mythic Panel',
    'site_description' => 'The official MythicPvP control panel.',
    ...
    'copyright' => '[MythicPvP](https://mythicpvp.net) — Mythic Panel',

    'isUnderMaintenance' => false,
    'maintenance' => 'We are currently under maintenance. Kindly check back later!',

    'alertType' => 'info',
    'alertMessage' => '**Welcome to Mythic Panel!** You can modify Theme Look & Feel using [Designify](/admin/designify) at the administration area.',
    'alerts' => '[{"type":"info","message":"**Welcome to Mythic Panel!** You can modify Theme Look & Feel using [Designify](/admin/designify) at the administration area."}]',
