...
class DesignifyComposer
{
    ...
    public function __construct()
    {
        ...
        $this->reviactylDefaults = [
            ...
            'copyright' => config('designify.copyright') ?? 'Powered by [Mythic Panel](https://mythicpvp.net/)',
            ...
            'alertMessage' => config('designify.alertMessage') ?? '**Welcome to Mythic Panel!** You can modify Theme Look & Feel using [Designify](/admin/designify) at the administration area.',
            'alerts' => $this->getAlertsConfig(),
            'site_color' => config('designify.site_color') ?? '#3b82f6',
            'site_title' => config('designify.site_title') ?? 'Mythic Panel',
            'site_description' => config('designify.site_description') ?? 'Our official control panel made better with Mythic Panel.',
    ...
    private function getAlertsConfig(): array
    {
        $fallback = [[
            ...
            'message' => config('designify.alertMessage') ?? '**Welcome to Mythic Panel!** You can modify Theme Look & Feel using [Designify](/admin/designify) at the administration area.',
        ]];
