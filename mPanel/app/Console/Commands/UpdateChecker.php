...
class UpdateChecker extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            $response = Http::get('https://mythicpvp.net/api/v26/get-version');
            if ($response->failed()) {
            ...
            if (! $latestVersion) {
                $this->error('Server sent invalid response. Reach out to Mythic Panel support team.');
            ...
            if ($latestVersion === $currentVersion) {
                ...
                $this->info('You\'re running pre-release of Mythic Panel.');
            }
        } catch (\Exception $e) {
