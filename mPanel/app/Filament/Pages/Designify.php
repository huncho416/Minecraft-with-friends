                    ...
                    Repeater::make('designify:sidebarButtons')
                        ...
                        ->schema([
                            ...
                            TextInput::make('url')
                                ...
                                ->placeholder('https://pma.mythicpvp.net')
                                ->maxLength(255),
